  ...
  return (
    <article>
      <p>
        ...
        <em>(or rather mine, cause I am the one person running it)</em> favorite
        shows.
      </p>
      <p>To start, select any of the {series.length} shows we have on offer!</p>
      <div className="tile">
        {series.map((s) => (
          <Link
            key={s.id}
          ...
          >
            <Card
              ...
              image={{
                src: `${frontendURL}/series/${s.id}/cover.jpg`,
                alt: `Coverart for ${s.name}`,
              }}
            >
              {s.name}
            </Card>
