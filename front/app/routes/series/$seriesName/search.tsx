...
import { Card, CardLinks, ExpandableCard, ExpandableCardLinks } from '../../../components'
                  ...
                  <ExpandableCard color={colors.accentColor} image={{
                    ...
                    <ul>
                      {episode.captions.sort((a, b) => a.order - b.order).map(caption => (
                        <li key={caption.id}>
                          <Link to={`/caption/${episode.id}?caption=${caption.id}`} dangerouslySetInnerHTML={{ __html: caption.text }}/>
                        </li>
                      ))}
                    </ul>
                  </ExpandableCard>
